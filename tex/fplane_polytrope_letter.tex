...
a best-fit to results from a linear instability
...
\added{finding the location of its first maxima away from the boundary.}
...
They demonstrate that the value of $\text{Ra}/\text{Ta}^{3/4}$ seems to determine
whether a flow is rotationally constrained or not. \cite{king&all2013} continued their
