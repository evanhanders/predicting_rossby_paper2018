...
Rossby number is plotted vs. Taylor number along multiple constant \pro
...
evolved solution \citep{julien&all1996, brummell&all1996}. Paths on constraint
III set constant a ratiow hich we call the ``Predictive Rossby Number'' (\pro).
These paths follow contours of Ta$^{3/4}$, and to our knowledge have not been
well-explored in the literature. An example of each of these paths
can be seen in Fig. \ref{fig:parameter_space}a.  

In this work, our goal is to study the nature of rotational constraint
