...
\begin{figure*}[t]
	...
	at $z = 0.95L_z$ are shown for select simulations. 
    ...
    case where there are large upflows and narrow, fast downflow lanes.
	%(see e.g., \AB).
    As the rotational constraint increases, Coriolis forces more effectively
...
of Ra at fixed \pro. We find that $\text{Nu} \propto \{\text{Ra}^{0.29 \pm 0.01}, \text{Ra}^{0.29 \pm 0.01}, \text{Ra}^{0.24}\}$
...
In our rotating domains, flows are distinctly different parallel to and perpendicular
