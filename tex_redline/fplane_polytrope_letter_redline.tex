...
\added{, and find scaling laws nearly identical to those in nonrotational convection at low
...
\added{In this work, we study three values of \pro$\,$ in depth. These values are shown in
...
\caption{ \added{Values of the critical Ra and Ta for each \pro$\,$ track are reported, as well as the
...
\added{Shockingly, when $\text{Ro} \lesssim 0.1$, 
...
\caption{\added{Input parameters and output parameters for select simulations are shown. For each of
