...
ax1.plot(x, y, c=Co_color, ls='--', lw=2, label='Co = 1')
...
ax1.plot(sigma[sig2, 3], sigma[sig2, 0], c=S_color, dashes=(4,1,2,1), lw=2, label=r'$\mathcal{S}=3$')
...
ax1.plot(new_c[c158, 2], new_c[c158, 1], c=Pro_color, lw=2, label=r'$\mathcal{P}_{\mathrm{Ro}} = 1.58$')
...
ax2.plot(sigma[sig2, 0], sigma[sig2, 1], marker=S_marker, color=S_color, lw=0, ms=6)
ax2.plot(sigma[sig1_1, 0], sigma[sig1_1, 1], marker=S_marker, color=S_color, lw=0, ms=3)
ax2.plot(original_co[co1, 0], original_co[co1, 1], marker=Co_marker, color=Co_color, lw=0, ms=6)
ax2.plot(original_co[co03, 0], original_co[co03, 1], marker=Co_marker, color=Co_color, lw=0, ms=4.5)
ax2.plot(original_co[co01, 0], original_co[co01, 1], marker=Co_marker, color=Co_color, lw=0, ms=3)
...
ax3.plot(c_sig, sigma[sig2, 1], marker=S_marker, lw=0, c=S_color, ms=6, label='$\mathcal{S} = 3$')
ax3.plot(c_sig_1, sigma[sig1_1, 1], marker=S_marker, lw=0, c=S_color, ms=3, label='$\mathcal{S} = 2$')
