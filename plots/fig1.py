...
ax1.plot(new_c[c158, 2], new_c[c158, 1], c='blue', lw=2, label=r'$\mathcal{C} = 1.58$')
...
ax2.plot(new_c[c158, 2], new_c[c158, 3], marker='*', color='blue', lw=0, ms=4, label=r'$\mathcal{C} = 1.58$')
ax2.plot(new_c[c957, 2], new_c[c957, 3], marker='o', color='blue', lw=0, ms=4, label=r'$\mathcal{C} = 0.96$')
...
c_sig = np.sqrt(sigma[sig1, 3]/sigma[sig1, 0]**(3/4))
